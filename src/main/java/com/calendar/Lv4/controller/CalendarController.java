...
public class CalendarController {
    ...
    public void deleteCalendar(@PathVariable("calendarId") Long calendarId, @RequestBody CalendarRequestDto requestDto) {
        calendarService.deleteCalendar(calendarId,requestDto);
    }
}